...
![image-title-here](../assets/images/2020418CreateServerMinecraft.jpg)
...
![image-title-here](../assets/images/minecraft-folder-1.png)
...
![image-title-here](../assets/images/minecraft-folder-2.png)

`Double chuột phải` vào file eula.txt và sửa đổi `eula=false` thành `eula=true`

![image-title-here](../assets/images/minecraft-eula-text.png)
...
![image-title-here](../assets/images/minecraft-file-server.png)
